...
@__CompressedAssemblyDescriptor_data_1 = internal global [2096640 x i8] zeroinitializer, align 1
...
@compressed_assembly_descriptors = internal global [85 x %struct.CompressedAssemblyDescriptor] [
	...
	; 1
	%struct.CompressedAssemblyDescriptor {
		i32 2096640, ; uncompressed_file_size
		i8 0, ; loaded
		i8* getelementptr inbounds ([2096640 x i8], [2096640 x i8]* @__CompressedAssemblyDescriptor_data_1, i32 0, i32 0); data
	}, 
	; 2
	%struct.CompressedAssemblyDescriptor {
